...
dt <- list(
  ...
  population = c(52984487, 51823583) 
)
...
fit_all <- stan(
 ...
 #save(fit_all, file='transmission_probability_reparam_different_means_nhanes_hetnonew_1000.RData')
...
plot(0,0,xlim=c(0,15), ylim=c(0.0001,1), pch='', xlab = "Number of partners", ylab = "Proportion of respondents", main='NHANES, Men', log='y', yaxt="n")
...
plot(0,0,xlim=c(0,15), ylim=c(0.0001,1), pch='', xlab = "Number of partners", ylab = "Proportion of respondents", main='NHANES, Women', log='y', yaxt="n")
