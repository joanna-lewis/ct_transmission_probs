...
#save(fit_all, file= 'transmission_probability_reparam_natsal2_hetnonew_1000.RData')
...
plot(0,0,xlim=c(0,15), ylim=c(0.0001,1), pch='', xlab = "Number of partners", ylab = "Proportion of respondents", main='Natsal-2, Men', log='y')
...
plot(0,0,xlim=c(0,15), ylim=c(0.0001,1), pch='', xlab = "Number of partners", ylab = "Proportion of respondents", main='Natsal-2, Women', log='y')
...
axis(2, at=c(0, 500, 1000), labels=c("0","","1000"))
